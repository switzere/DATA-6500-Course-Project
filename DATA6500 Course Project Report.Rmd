...
tm_shape(toronto_basemap) +
  ...
  tm_dots(col = "subwayLine", size = 0.2, legend.show = FALSE, palette = "Set1") +
  tm_shape(toronto_subwayLines) +
  tm_lines(col = "name", size = 0.5, legend.show = FALSE, palette = "Set1", col.title="Subway Line")
```
...
```{r, cache = TRUE, echo=FALSE, results='hide', message=FALSE, warning=FALSE, include = FALSE}
